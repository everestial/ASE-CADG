...
def main():
    ...
    parser.add_argument("--unphased", default='no',
                        help="include unphased variants in the output - options: yes or no")
    ...
    with open(args.out, 'w') as write_block:
        ...
        output_header = ['chrom', 'pos', 'ref', 'all_alleles', 'all_freq']
        ...
        for variant in vcf_file:
            ...
            for n, pi_value in enumerate(PI_values):
                ...
                # in some instances there are "*" in the GT, which we currently replace as "."
